package com.spring.oauth2_authorization_server.base.controllers;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.spring.oauth2_authorization_server.base.models.BaseResponse;
import com.spring.oauth2_authorization_server.base.models.FieldValidationError;
...
public abstract class BaseRESTController {
    ...
    public BaseResponse onAccessDenied(Exception e) {
        return new BaseResponse(ResponseValue.AUTHENTICATION_REQUIRED);
    }
